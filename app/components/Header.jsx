...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 '>
      ...
      whileInView={{ y: 0 , opacity: 1  }}
      transition={{ duration: 0.6 , delay : 1}}
          href={getAssetPath('/Pramodi_Peshila_SE_CV.pdf')} download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>My Resume
