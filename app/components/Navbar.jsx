...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50  ${isScroll ? "backdrop-blur-lg shadow-sm bg-darkTheme/80 shadow-white/20" : ""}`}>
        <a href="#top">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-white/50 rounded-full ml-4 font-Ovo'>
        ...
        {/* Mobile menu */}
        <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-[#11001F] text-white transition duration-500">
