        ...
        className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10'>
              {serviceData.map(({ icon, title, description, link }, index) => (
                <motion.div
                  ...
                  key={index} className='border border-gray-400 rounded-lg px-8 py-12 hover-shadow-black cursor-pointer hover-bg-lightHover hover:translate-y-1 duration-500 hover-bg-darkHover hover-shadow-white '>
